...
/** /etwt dd-mm-yyyy [dd-mm-yyyy] — estimated vs actual work time. */
async function handleEtwt(bot, chatId, telegramUserId, args) {
  ...
  await bot.sendMessage(chatId, 'Fetching estimated vs work time...');
...
/** /run [dd-mm-yyyy] — own report for that day (default today). */
